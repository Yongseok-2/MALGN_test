...
- 서버를 실행합니다.
- `npm run dev`
- 실행이 완료되면 터미널에 안내된 로컬 주소를 브라우저에 입력하여 서비스에 접속합니다.
- `http://localhost:5173`
---

## 기본 세팅
- 일반 사용자 id: user1 / pw: 1234
- 관리자 id: admin1 / pw: 1234
...
* **파일 첨부와 다운로드 기능**
  - multipart/form-data 형식을 지원하여 게시글과 함께 여러 개의 파일을 업로드할 수 있는 기능 구현
  - HTTP 응답의 Content-Disposition 헤더를 조작하여 다운로드 기능 구현
* **마이페이지 (내 글 보기)**
